...
// ＤＸライブラリのバージョン
#define DXLIB_VERSION 0x317c
#define DXLIB_VERSION_STR_T _T( "3.17c" )
#define DXLIB_VERSION_STR_W    L"3.17c"
...
extern	int			DrawBoxAA(        float x1, float y1, float x2, float y2,                                         unsigned int Color, int FillFlag, float LineThickness = 1.0f ) ;			// 四角形の描画する( アンチエイリアス付き )
